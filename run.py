...
# multi cycle
parser.add_argument('--cycle_lens', type=str, required=False,default="24_48 168_84",
                    help='各尺度周期配置，格式: "24_48 168_84"')
...
if args.cycle_lens is not None:
    args.cycle_lens = parse_cycle_lens(args.cycle_lens)
